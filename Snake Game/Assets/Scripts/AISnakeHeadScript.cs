...
public class AISnakeHeadScript : MonoBehaviour
{
    ...
    {
        foreach (GameObject segment in GameObject.FindGameObjectsWithTag("Snake Head"))
        {
    ...
    private void FruitSequence(GameObject fruit)
    {
        ...
        FindObjectOfType<AISnakeMovement>().FruitEaten();
    }
    ...
    private void SnakeDeathSequence()
    {
        ...
        FindObjectOfType<SnakeMovement>().SetSnakeStatus(true);
